...
<div class="page-title">
    ...
    <h2 class="title-text">勤怠詳細（管理者編集後）</h2>
</div>
...
<div class="attendance-detail-container">
    <table class="detail-table">
        ...
        <tr>
            ...
            <td class="time-cell">
                @php
                $break1 = collect($customBreaks)->firstWhere('order', 1);
                $break1startFormatted = $break1['start'] ?? '';
                $break1endFormatted = $break1['end'] ?? '';
                @endphp
        ...
        <tr>
            ...
            <td class="time-cell">
                @php
                $break2 = collect($customBreaks)->firstWhere('order', 2);
                $break2startFormatted = $break2['start'] ?? '';
                $break2endFormatted = $break2['end'] ?? '';
                @endphp
