            ...
            <tr>
                ...
                <td>
                    <input type="time" name="break1_start"
                        value="{{ old('break1_start', $customBreaks[0]['start'] ?? '') }}">
                    ～
                    <input type="time" name="break1_end"
                        value="{{ old('break1_end', $customBreaks[0]['end'] ?? '') }}">
                    <div class="error">
            ...
            <tr>
                ...
                <td>
                    <input type="time" name="break2_start"
                        value="{{ old('break2_start', $customBreaks[1]['start'] ?? '') }}">
                    ～
                    <input type="time" name="break2_end"
                        value="{{ old('break2_end', $customBreaks[1]['end'] ?? '') }}">
                    <div class="error">
